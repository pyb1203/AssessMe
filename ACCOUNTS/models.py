...
class CourseDetail(models.Model):
    ...
    PId=models.ForeignKey(ProfessorDetail,max_length=20,null=False,on_delete=models.CASCADE)
...
class AssistantDetail(models.Model):
    ...
    Name = models.CharField(max_length=20,null=False)
    Email = models.EmailField()
    CourseId= models.ForeignKey(CourseDetail,max_length=20,null=False,on_delete=models.CASCADE)
    Password=models.CharField(max_length=20,null=False)
...
class AssignmentQuestion(models.Model):
    QId=models.ForeignKey(QuestionDetail,null=False,max_length=20,on_delete=models.CASCADE)
    AId=models.ForeignKey(AssignmentDetail,null=False,max_length=20,on_delete=models.CASCADE)

    def __str__(self):
        return self.id;

class Submission(models.Model):
    StudentId=models.ForeignKey(StudentDetail,null=False,on_delete=models.CASCADE)
    AssignmentId=models.ForeignKey(AssignmentDetail,null=False,on_delete=models.CASCADE)
    QuestionId=models.ForeignKey(QuestionDetail,null=False,on_delete=models.CASCADE)
...
class Courses_Ta(models.Model):
    CourseId=models.ForeignKey(CourseDetail,null=False,on_delete=models.CASCADE)
    TaId=models.ForeignKey(AssistantDetail,null=False,on_delete=models.CASCADE)

    def __str__(self):
        return self.CourseId;

class Course_student(models.Model):
    SId=models.ForeignKey(StudentDetail,to_field='SId',null=False,on_delete=models.CASCADE)
    CourseId=models.ForeignKey(CourseDetail,null=False,on_delete=models.CASCADE)
